    ...
    <>
      ...
      <section>
        ...
        <p>
          ...
          la cual se le dara acceso a las anteriores funciones y dicha cuenta se
          almacenara en la base de datos, logrando así un sistema seguro y
      ...
      <section>
        ...
        <p>
          Las herraminetas que se utilizaron para el desarrollo de este sitio
          son principalmente de reat, como la biblioteca de react-reoter-dom, de
          la cual se usaron herramientas como Link, para las rutas del Header o
          hooks de react como useState para los estados y useEffect para
          ejecutar funciones de forma secundaria.
        </p>
      </section>
    </>
  );
